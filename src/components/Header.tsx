  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-gray-divider px-4 py-3">
      <div className="flex items-center justify-between mb-3">
        <h1 className="text-xl font-bold text-olive-500">FreshCut</h1>
      ...
      <div className="relative">
        <input
          ...
          className="w-full bg-light-100 border-none rounded-full py-2 px-10 text-sm focus:ring-1 focus:ring-fresh-500 outline-none placeholder:text-gray-400"
        />
